...
// Composant BoutonAjouter utilisé pour afficher un bouton
export default function BoutonAjouter({ clickHandler, ToggleHandler, text }) {
  return (
    <button
      ...
      onClick={() => {
        clickHandler(); // Appel de la fonction clickHandler lors du clic sur le bouton
        ToggleHandler && ToggleHandler(); // Appel de la fonction ToggleHandler si elle est définie lors du clic sur le bouton
      }}
    >
