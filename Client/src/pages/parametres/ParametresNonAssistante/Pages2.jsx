...
export default function Pages2({ utilisateur_id }) {
  ...
  function validation(data) {
    if (
      ...
      !contientLettreMinuscule(data.nouveau_mot_de_passe) ||
      !contientLettreMajuscule(data.nouveau_mot_de_passe) ||
      !contientChiffre(data.nouveau_mot_de_passe) ||
      !contientCaractereSpecial(data.nouveau_mot_de_passe) ||
      champVide(data)
    ) {
      return false;
    } else {
  ...
  return (
    <form className="flex flex-col items-end gap-5" id="form">
      ...
      <div className="flex flex-col">
        ...
        {validation(formData) && clicked && matches && (
